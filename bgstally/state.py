...
class State:
    ...
    def load(self):
        ...
        # TODO: Legacy values, used to migrate initial state, remove in future version        self.DiscordBGSWebhook:tk.StringVar = tk.StringVar(value=config.get_str('XDiscordWebhook', default=""))
        ...
        self.ExplorationEnabled = tk.BooleanVar(value=config.get_bool('BGST_ExplorationEnabled', default=False))
        self.ExplorationApiEndpoint = tk.StringVar(value=config.get_str('BGST_ExplorationApiEndpoint', default=""))
        self.ExplorationApiKey = tk.StringVar(value=config.get_str('BGST_ExplorationApiKey', default=""))
    ...
    def save(self):
        ...
        # Exploration settings
        config.set('BGST_ExplorationEnabled', self.ExplorationEnabled.get())
        config.set('BGST_ExplorationApiEndpoint', self.ExplorationApiEndpoint.get())
        config.set('BGST_ExplorationApiKey', self.ExplorationApiKey.get())
